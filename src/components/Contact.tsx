...
const links = [
  {
    label: 'Email',
    value: 'chetansingh210703@gmail.com',
    href: 'mailto:chetansingh210703@gmail.com',
    icon: (
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/chetansingh210703',
